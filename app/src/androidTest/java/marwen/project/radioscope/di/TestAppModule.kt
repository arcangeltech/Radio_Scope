...
object TestAppModule {
    ...
    fun provideRadioScopeRepository(api: RadioScopeApi): RadioScopeRepository =
        RadioScopeRepositoryFake()

    @Singleton
    @Provides
    //fun provideRadioScopeRepository(api : RadioScopeApi) : RadioScopeRepository = RadioScopeRepositoryImpl(api)}
    fun provideGetHomeRadioUseCase(radioScopeRepository: RadioScopeRepository): GetHomeRadioUseCase =
        GetHomeRadioUseCaseImpl(radioScopeRepository)
}